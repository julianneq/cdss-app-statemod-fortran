...
def writeNewFiles(filename, firstLine, sampleNo, realizationNo, allMonthlyData, LHsamples_file):
    ...
    f = open('/oasis/scratch/comet/jdq2101/temp_project/Colorado/' + LHsamples_file[0:-4] + '/' + filename[0:-4] + '_S' + str(sampleNo) + '_' + str(realizationNo) + filename[-4::],'w')
