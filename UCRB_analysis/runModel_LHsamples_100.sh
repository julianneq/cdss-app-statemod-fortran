...
#SBATCH --job-name="runModel_LHsamples_100" # name your job
#SBATCH --output="runModel_LHsamples_100.out"
...
ibrun python3 runModel.py LHsamples_original_100_AnnQonly
ibrun python3 runModel.py LHsamples_wider_100_AnnQonly