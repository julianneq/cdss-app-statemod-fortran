...
# ibrun python3 createDDMfiles.py LHsamples_original_200_AnnQonly
# ibrun python3 createDDMfiles.py LHsamples_original_1000_AnnQonly
# ibrun python3 createDDMfiles.py LHsamples_narrowed_200_AnnQonly
# ibrun python3 createDDMfiles.py LHsamples_narrowed_1000_AnnQonly
# ibrun python3 createDDMfiles.py LHsamples_wider_200_AnnQonly
ibrun python3 createDDMfiles.py LHsamples_wider_1000_AnnQonly
# ibrun python3 createDDMfiles.py CMIP_SOWs
