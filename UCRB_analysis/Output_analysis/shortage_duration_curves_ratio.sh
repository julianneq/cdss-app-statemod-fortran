...
ibrun python3 shortage_duration_curves_ratio.py LHsamples_original_100_AnnQonly
ibrun python3 shortage_duration_curves_ratio.py LHsamples_wider_100_AnnQonly
